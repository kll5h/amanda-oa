...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AmandaOA@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AmandaOA API";

        private String description = "AmandaOA API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AmandaOA";
